class VouchersController < ApplicationController
  ...
  private
    ...
    def voucher_params
      params.require(:voucher).permit(:customer_id, :bank_id, :purchase_order, :confirmation_number, :description, :cheque_date, :cheque_number, :account_id, :department_id, particulars_attributes: [:id, :voucher_id, :description, :amount, :_destroy])
    end
end
